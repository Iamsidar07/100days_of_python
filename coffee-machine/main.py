...
def is_resources_sufficient(order_ingredients):
    """
    Returns True when drink can be made, or False if ingredients are insufficient
    """
...
def is_payment_successful(payment_received, drink_cost):
    """Returns True if the payment is successful or False"""
...
def make_coffee(drink_name, order_ingredients):
    ...
    for item in order_ingredients:
        global resources
        resources -= order_ingredients[item]
